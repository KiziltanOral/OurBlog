...
using OurBlog.Areas.Admin.Models;
using OurBlog.Data;
...
namespace OurBlog.Areas.Admin.Controllers
{
    ...
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create(NewPostViewModel vm)
        {
            ...
            {
                // TODO: Resim varsa yükle ve ismini kaydedilecek entity e aktar.
                Post post = new Post()
                {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Content,Image,AuthorId")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
